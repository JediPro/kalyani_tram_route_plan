...
ggplot() +
  ...
  tidyterra::geom_spatraster(data = dist_station, aes(fill = popn)) +
...
vc_station <- st_sample(x = sf_city_limits, size = param_n_station) %>% 
  # convert to SpatVector
  vect()
# Calculate distance from each point to all cells of raster
dist_station <- distance(x = rs_popn, y = vc_station)
