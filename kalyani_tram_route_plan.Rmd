...
fx_ga_crossover_popn <- function(obj_ga, parent_indices, p_cross_subset){
  ...
  return(list(population = mtx_children, fitness = c(NA_real_, NA_real_)))
}

# Function to implement mutation ----------------------------------
fx_ga_mutate_popn <- function(ga_obj, parent_index, std_mutation_shift, p_mutation_subset){
  # mtx_popn = mtx_popn_sample
  # parent_index = c(2)
