...
fx_ga_mutate_popn <- function(obj_ga, vec_parent){
  ...
  # 3: Exchange of a pair of stations between 2 lines
  # 4: Transfer of a station from one line to another
  # 5: Deletion of a station from a line
  # 6: Addition of randomly selected station to a line
