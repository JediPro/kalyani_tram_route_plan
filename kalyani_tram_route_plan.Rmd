...
bbox_polygon <- st_bbox(obj = bbox, crs = st_crs(feat_major_road$osm_lines)) %>% 
  # Convert to sf
  st_as_sfc()
...
rs_popn <- terra::rast(x = "GHS_POP_E2030_GLOBE_R2023A_54009_100_V1_0_R7_C27.tif")
rs_popn <- rs_popn %>% 
...
ggplot() + tidyterra::geom_spatraster(data = rs_popn, 
                                      mapping = aes(fill = GHS_POP_E2030_GLOBE_R2023A_54009_100_V1_0_R7_C27)) +
  geom_sf(data = sf_city_road, mapping = aes(geometry = geometry))
```
