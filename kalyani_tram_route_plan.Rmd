...
# Define sample matrix for functions ---------------------
...
# Function to check connectedness and calculate fitness function
...
sc_connected <- igraph::is_connected(sfnet_individual, mode = "weak")
